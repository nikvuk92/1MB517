...
```
plink --bfile ALL_MERGED_DATASETS --remove RefInd1.fam --make-bed --out FINAL_DATASET  
```
...
```
sbatch -A uppmax2022-2-21 -M snowy -p core -n 2 -t 07:00:00 -J PCA pca_lsqproj.sh YOUR_PRUNED_DATASET_TPED MODERN.txt UNKNOWN.txt
```
